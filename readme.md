...
Inicialmente as imagens foram inseridas separadas das classes onde contem as animações.
...
Após a função ser ativada o HTML terá o seguinte comportamento, onde a classe será removida pelo JavaScript após o tempos configurado que durará a animação do salto.
